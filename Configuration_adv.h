 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MAXIMUM_STEPPER_RATE 5200000
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_FEEDRATE         64  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     14  // (mm/s) Unload filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        26  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     26  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      26  // (mm/s) feedrate to purge before unload
 ...
 */
  ...
  #define MONITOR_DRIVER_STATUS
    ...
    #define CURRENT_STEP_DOWN     40  // [mA]
